...
static void qdict_put_obj_test(void)
{
    ...
    qdict_put_obj(qdict, "", QOBJECT(qnum_from_int(num)));
...
static void qdict_destroy_simple_test(void)
{
    ...
    qdict = qdict_new();
    qdict_put_obj(qdict, "num", QOBJECT(qnum_from_int(0)));
...
static void qdict_get_test(void)
{
    ...
    qdict_put(tests_dict, key, qnum_from_int(value));
...
static void qdict_get_try_uint_test(void)
{
    ...
    qdict_put(tests_dict, key, qnum_from_int(ivalue));
    /* try_uint will work with int types too */
    ret = qdict_get_try_uint(tests_dict, key, 0);
    g_assert_cmpint(ret, ==, ivalue);

    qdict_put(tests_dict, key, qnum_from_uint(uvalue));
    ret = qdict_get_try_uint(tests_dict, key, 0);
    g_assert_cmpint(ret, ==, uvalue);

    qdict_put(tests_dict, key, qnum_from_int(-1));
    /* try_uint will will work with negative int values, for
     * compatibility reasons */
    ret = qdict_get_try_uint(tests_dict, key, 0);
    g_assert_cmpint(ret, ==, (uint64_t)-1);
...
static void qdict_haskey_test(void)
{
    ...
    qdict_put(tests_dict, key, qnum_from_int(0));
...
static void qdict_iterapi_test(void)
{
    ...
    qdict_put(tests_dict, "key1", qnum_from_int(1));
    qdict_put(tests_dict, "key2", qnum_from_int(2));
    qdict_put(tests_dict, "key3", qnum_from_int(3));
...
static void qdict_flatten_test(void)
{
    ...
    qdict_put(dict1, "a", qnum_from_int(0));
    qdict_put(dict1, "b", qnum_from_int(1));

    qlist_append_obj(list1, QOBJECT(qnum_from_int(23)));
    qlist_append_obj(list1, QOBJECT(qnum_from_int(66)));
    qlist_append_obj(list1, QOBJECT(dict1));
    qlist_append_obj(list2, QOBJECT(qnum_from_int(42)));
    qlist_append_obj(list2, QOBJECT(list1));

    qdict_put(dict2, "c", qnum_from_int(2));
    qdict_put(dict2, "d", qnum_from_int(3));
    qdict_put_obj(dict3, "e", QOBJECT(list2));
    qdict_put_obj(dict3, "f", QOBJECT(dict2));
    qdict_put(dict3, "g", qnum_from_int(4));
...
static void qdict_array_split_test(void)
{
    ...
    qdict_put(test_dict, "1.x", qnum_from_int(0));
    qdict_put(test_dict, "4.y", qnum_from_int(1));
    qdict_put(test_dict, "0.a", qnum_from_int(42));
    qdict_put(test_dict, "o.o", qnum_from_int(7));
    qdict_put(test_dict, "0.b", qnum_from_int(23));
    qdict_put(test_dict, "2", qnum_from_int(66));
    ...
    qdict_put(test_dict, "0", qnum_from_int(42));
    qdict_put(test_dict, "1", qnum_from_int(23));
    qdict_put(test_dict, "1.x", qnum_from_int(84));
...
static void qdict_array_entries_test(void)
{
    ...
    qdict_put(dict, "bar", qnum_from_int(0));
    qdict_put(dict, "baz.0", qnum_from_int(0));
    g_assert_cmpint(qdict_array_entries(dict, "foo."), ==, 0);

    qdict_put(dict, "foo.1", qnum_from_int(0));
    g_assert_cmpint(qdict_array_entries(dict, "foo."), ==, -EINVAL);
    qdict_put(dict, "foo.0", qnum_from_int(0));
    g_assert_cmpint(qdict_array_entries(dict, "foo."), ==, 2);
    qdict_put(dict, "foo.bar", qnum_from_int(0));
    g_assert_cmpint(qdict_array_entries(dict, "foo."), ==, -EINVAL);
    qdict_del(dict, "foo.bar");

    qdict_put(dict, "foo.2.a", qnum_from_int(0));
    qdict_put(dict, "foo.2.b", qnum_from_int(0));
    qdict_put(dict, "foo.2.c", qnum_from_int(0));
    ...
    dict = qdict_new();
    qdict_put(dict, "1", qnum_from_int(0));
    g_assert_cmpint(qdict_array_entries(dict, ""), ==, -EINVAL);
    qdict_put(dict, "0", qnum_from_int(0));
    g_assert_cmpint(qdict_array_entries(dict, ""), ==, 2);
    qdict_put(dict, "bar", qnum_from_int(0));
    g_assert_cmpint(qdict_array_entries(dict, ""), ==, -EINVAL);
    qdict_del(dict, "bar");

    qdict_put(dict, "2.a", qnum_from_int(0));
    qdict_put(dict, "2.b", qnum_from_int(0));
    qdict_put(dict, "2.c", qnum_from_int(0));
...
static void qdict_join_test(void)
{
    ...
    do
    {
        ...
        qdict_put(dict2, "foo", qnum_from_int(42));
        ...
        qdict_put(dict2, "bar", qnum_from_int(23));
        ...
        /* Test conflict */
        qdict_put(dict2, "foo", qnum_from_int(84));
...
static void qdict_put_exists_test(void)
{
    ...
    qdict_put(tests_dict, key, qnum_from_int(1));
    qdict_put(tests_dict, key, qnum_from_int(2));
