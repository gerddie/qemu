...
static void test_dispatch_cmd_failure(void)
{
    ...
    req = qdict_new();
    qdict_put(args, "a", qnum_from_int(66));
...
static void test_dispatch_cmd_io(void)
{
    ...
    qdict_put_obj(ud1a, "integer", QOBJECT(qnum_from_int(42)));
    qdict_put_obj(ud1a, "string", QOBJECT(qstring_from_str("hello")));
    qdict_put_obj(ud1b, "integer", QOBJECT(qnum_from_int(422)));
    ...
    qdict_put(args3, "a", qnum_from_int(66));
